...
class DemoMention extends Component {
  constructor() {
    super();
    this.state = {
      triggerValue: "",
  ...
  render() {
    const defaultValue =
      '<a href="#" data-tag="react-taggable-input">#react-taggableinput</a>&nbsp;<a href="#" data-tag="鉅亨網">#鉅亨網</a>&nbsp;made with ♥';
    return (
      <div className="index">
        <TaggableInput
        ...
        />
        <ul>
          <li onClick={this.applyTag}>
            {this.state.triggerValue || "no result"}
          </li>
        </ul>
      </div>
    );
...
DemoMention.defaultProps = {};

export default DemoMention;
